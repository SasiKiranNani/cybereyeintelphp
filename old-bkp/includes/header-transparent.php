...
<head>
   ...
   <link rel="shortcut icon" type="image/x-icon" href="assets/images/xfavicon.png.pagespeed.ic.RYu9Fa_nY7.png">
   <!-- CSS here -->
      ...
      <div class="itoffcanvas">
         ...
         <div class="itoffcanvas__info">
            ...
            <div class="it-info-wrapper mb-20 d-flex align-items-center">
               ...
               <div class="itoffcanvas__info-address">
                  <span>Phone</span>
                  <a href="tel:(00)45600000000">(00) 456 0000 0000</a>
               </div>
            </div>
            <div class="it-info-wrapper mb-20 d-flex align-items-center">
               <div class="itoffcanvas__info-icon">
               ...
               <div class="itoffcanvas__info-address">
                  <span>Location</span>
                  <a href="#" target="_blank">Austin, TX 78704 USA </a>
               </div>
            </div>
         </div>
      </div>
                     ...
                     <div class="row align-items-center">
                        <div class="col-xl-2 col-6">
                           <div class="it-header-2-logo">
                              <a href="index.php"><img src="assets/images/l.png" alt=""></a>
                           </div>
                        </div>
                                 ...
                                 <ul>
                                    ...
                                    <li class="has-dropdown">
                                       ...
                                       <ul class="it-submenu submenu">
                                          <li><a href="cybersecurity-fundamentals.php">Cybersecurity Fundamentals</a></li>
